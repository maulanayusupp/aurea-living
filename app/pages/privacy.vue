...
const { t } = useI18n()
const sections = getLegalSections('privacy')
...
const title = (s: LegalSection) => t(s.titleKey)
const body = (s: LegalSection) => t(s.bodyKey)
</script>
...
<template>
  <div>
    <PageHero
      ...
      :lead="t('privacy.lead')"
    />
    <LegalDocument :sections="sections" :title="title" :body="body" :updated="t('legal.updated')" />
  </div>
</template>
